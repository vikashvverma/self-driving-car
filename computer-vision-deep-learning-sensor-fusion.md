...
def measure_curvature_pixels():
    ...
    left_curverad = np.power((1 + (2*left_fit[0]*y_eval + left_fit[1])**2), 3/2)/np.abs(2*left_fit[0])   ## Implement the calculation of the left line here
    right_curverad = np.power((1+(2*right_fit[0]*y_eval + right_fit[1])**2), 3/2)/np.abs(2*right_fit[0])  ## Implement the calculation of the right line here
...
![img](https://d17h27t6h515a5.cloudfront.net/topher/2017/January/588d4292_screen-shot-2017-01-28-at-5.06.11-pm/screen-shot-2017-01-28-at-5.06.11-pm.png)
...
Double check the bottom of the page [here](https://classroom.udacity.com/nanodegrees/nd013/parts/fbf77062-5703-404e-b60c-95b78b2f3f9e/modules/2b62a1c3-e151-4a0e-b6b6-e424fa46ceab/lessons/096009a1-3d76-4290-92f3-055961019d5e/concepts/474a329a-78d0-4a33-833a-34d02a35fc13) to remind yourself how this works.
...
![img](https://d17h27t6h515a5.cloudfront.net/topher/2016/December/5844e7d1_lane-drawn/lane-drawn.jpg)
